...
export default function StoreDetailPage() {
  const orders = [
    { user: "Kiana", userImage: "/images/avatar_kiana.png", order: "Dasi", status: "Unpaid", statusImage: "/images/status_unpaid.png", total: "Rp 350k", statusColor: "text-red-500" },
    { user: "Ardi", userImage: "/images/avatar_ardi.png", order: "Sabuk", status: "Unpaid", statusImage: "/images/status_unpaid.png", total: "Rp 173k", statusColor: "text-red-500" },
    { user: "Leon", userImage: "/images/avatar_leon.png", order: "Topi", status: "Paid", statusImage: "/images/status_paid.png", total: "Rp 812k", statusColor: "text-green-600" },
  ];
        ...
        <div className="flex gap-4">
          ...
          <div className="w-56 bg-gray-100 rounded-2xl p-5 flex flex-col items-center justify-center gap-3">
            ...
            <div className="flex items-end gap-0.5">
              <Image src="/images/store_icon.png" alt="Store" width={32} height={28} className="object-cover" />
            </div>
